import os
vina_file = '/mnt/processed_data/vina_score_test.txt'
feature_file = '/mnt/processed_data/feature_test.txt'
feature_order_file = '/mnt/processed_data/core_set_protein.txt'
...
output_file = '/mnt/processed_data/model_feaure_test_output.txt'
with open(output_file,'w') as fo:
    for protein in vina_score.keys():
        if protein not in ground_truth.keys():
            continue
